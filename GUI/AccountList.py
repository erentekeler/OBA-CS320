...
def createWindow():
    ...
    layout = [[sg.Text('Select the Account: ',size = (17, 1), font=('Arial',12,'bold')), sg.Combo([], key='AccNames', enable_events=True, size = 40), sg.Button('Refresh Accounts', size=(5,1),font=("Arial",12,'bold'), pad=(10,10), button_color='Dark Grey')],
